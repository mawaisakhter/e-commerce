...
const ContactUs = () => {
  return (
    <div className="flex justify-center items-center mt-12 mb-20">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 px-4 md:px-20 p-6">
        <div className="col-span-1 md:col-span-4 p-6 bg-white drop-shadow-2xl">
        ...
        <div className="col-span-1 md:col-span-8 p-6 bg-white drop-shadow-2xl pb-10">
