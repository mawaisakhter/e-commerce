        ...
        <>
          <div className='mx-16 mt-24'>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl md:text-3xl mt-3 font-semibold capitalize mb-5">Flash sales</h2>
                {/* <CountdownTimer/> */}
              </div>
              <div className="flex items-center gap-2">
                <button className="bg-color-secondary rounded-full duration-300 ease-in-out transition-colors hover:bg-color-secondary-hover">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="m-3 w-5 h-5 max-md:w-4 max-md:h-4 -rotate-90" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='text-center'>
              <Link to="#" className="text-white bg-red-700 hover:bg-red-800 font-medium rounded-md text-md px-5 py-2.5">View All Products</Link>
              <hr className='border-gray-400 mt-16 mb-20' />
            </div>
          </div>
        </>
    );
